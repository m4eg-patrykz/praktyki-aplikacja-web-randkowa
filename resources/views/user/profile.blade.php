...
@section('content')
                ...
                <a href="{{ url('/settings') }}" class="fixed top-4 left-4 z-30
                            ...
                            <form method="POST"
                                ...
                                <section class="grid md:grid-cols-[auto,1fr] gap-10 md:gap-16 md:items-center">
                                    ...
                                    <div class="grid sm:grid-cols-3 gap-4 md:pl-4">
                                        ...
                                        {{-- Data urodzenia --}}
                                        <div>
                                            <label for="date_of_birth" class="mb-1 block text-sm font-medium">Data urodzenia</label>
                                ...
                                <section class="space-y-2">
                                    ...
                                    <select id="orientation" name="orientation"
                                        ...
                                        @foreach($orientations as $value => $label)
                                            <option value="{{ $value }}"
                                                @selected(old('orientation', $user->sexual_orientation_id) == $value)>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
